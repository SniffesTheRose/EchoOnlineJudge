...
<div id="Left_Naviqation" class="Left_Naviqation na">
	<div class="Left_Profile_Container">
        <div class="Left_Profile_Image_Container">
            <img id="user" width="55px" class="img-circle" src="<?php echo $UserImageFile;?>" />
            <span id="badge" class="badge badge-info Badge_Point">1</span>
            <a href="../Users/Settings.php"><span class="badge badge-info settings"><i class="fa fa-cog" style="font-size:15px"></i></span></a>
        </div>
